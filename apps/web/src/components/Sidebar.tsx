...
function AppWordmark() {
  return (
    <span className="inline-flex size-6 shrink-0 items-center justify-center rounded-md border border-border bg-card text-[10px] font-semibold tracking-[0.18em] text-foreground">
      SC
    </span>
  );
}
