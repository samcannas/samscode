...
export function ContextWindowMeter({ usage }: { usage: ContextWindowSnapshot }) {
  ...
  return (
    <Tooltip>
      <TooltipTrigger>
        ...
        >
          <span className="relative flex h-6 w-6 items-center justify-center">
            ...
            <span className="relative flex h-[15px] w-[15px] items-center justify-center rounded-full bg-background text-[8px] font-medium text-muted-foreground">
      ...
      <TooltipPopup side="top" align="end" className="max-w-none px-3 py-2">
