...
export const DEFAULT_KEYBINDINGS: ReadonlyArray<KeybindingRule> = [
  ...
  { key: "alt+arrowup", command: "thread.previous", when: "!terminalFocus" },
  { key: "alt+arrowdown", command: "thread.next", when: "!terminalFocus" },
  { key: "alt+1", command: "thread.jump.1", when: "!terminalFocus" },
  { key: "alt+2", command: "thread.jump.2", when: "!terminalFocus" },
  { key: "alt+3", command: "thread.jump.3", when: "!terminalFocus" },
  { key: "alt+4", command: "thread.jump.4", when: "!terminalFocus" },
  { key: "alt+5", command: "thread.jump.5", when: "!terminalFocus" },
  { key: "alt+6", command: "thread.jump.6", when: "!terminalFocus" },
  { key: "alt+7", command: "thread.jump.7", when: "!terminalFocus" },
  { key: "alt+8", command: "thread.jump.8", when: "!terminalFocus" },
  { key: "alt+9", command: "thread.jump.9", when: "!terminalFocus" },
