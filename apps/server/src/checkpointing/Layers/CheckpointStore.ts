...
import { CheckpointRef } from "@samscode/contracts";
        ...
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "Sam's Code",
              GIT_AUTHOR_EMAIL: "samscode@users.noreply.github.com",
              GIT_COMMITTER_NAME: "Sam's Code",
              GIT_COMMITTER_EMAIL: "samscode@users.noreply.github.com",
            };
