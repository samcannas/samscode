...
export function supportsClaudeXHighEffort(model: string | null | undefined): boolean {
  return normalizeModelSlug(model, "claudeAgent") === CLAUDE_OPUS_4_7_MODEL;
}
...
export function getReasoningEffortOptions(
  ...
  if (provider === "claudeAgent") {
    if (supportsClaudeXHighEffort(model)) {
